...
doit(Tx, Trees, NewHeight) ->
    ...
    true = oracle:done_timer(Oracle) < NewHeight,
    true = oracle:start(Oracle) < NewHeight,
    Result = oracles:type(Oracle),
    Oracle2 = oracle:set_result(Oracle, Result),
    Oracle3 = oracle:set_done_timer(Oracle2, NewHeight),
