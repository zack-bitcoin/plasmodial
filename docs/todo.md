...
These limitations need to be in channel_solo_close and channel_slash.


oracle_new should only ask questions at the right price. There are notes in oracle_new_tx.erl


We need a test of channel_timeout to make sure the shares move correctly.
...
tests for the oracle transaction types.
